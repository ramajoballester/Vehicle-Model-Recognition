...
Download the [Stanford Cars Dataset](https://ai.stanford.edu/~jkrause/cars/car_dataset.html) inside ```Vehicle-Model-Recognition/```. The complete dataset can be downloaded directly from [here](imagenet.stanford.edu/internal/car196/car_ims.tgz) and the annotation file from [here](imagenet.stanford.edu/internal/car196/cars_annos.mat).
